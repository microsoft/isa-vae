...
class VAE(nn.Module):
    ...
    def elbo(self, x, dataset_size, use_mse_loss=False, mse_sigma = 0.01):
...
def display_samples(model, x, vis, num_channels=1):
...
def main():
    ...
    parser.add_argument('-dist', default='normal', type=str, choices=['normal', 'laplace', 'flow', 'lpnorm', 'lpnested', 'studentt'])
    ...
    while iteration < num_iterations:
        for i, x in enumerate(train_loader):
            ...
            obj, elbo, logpx = vae.elbo(x, dataset_size, use_mse_loss=args.use_mse_loss, mse_sigma=args.mse_sigma)
            ...
            if iteration % args.log_freq == 0:
                ...
                if args.visdom:
                    if args.dataset == 'celeba':
                        ...
                        num_channels = 1
                    display_samples(vae, x, vis, num_channels)
