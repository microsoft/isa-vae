...
def elbo_decomposition(vae, dataset_loader, use_cuda=True):
    n_samples = 10000
...
if __name__ == '__main__':
    ...
    def load_model_and_dataset(checkpt_filename):
        ...
        if args.dist == 'normal':
            ...
            q_dist = dist.Laplace()
        vae = VAE(z_dim=args.latent_dim, use_cuda=use_cuda, prior_dist=prior_dist, q_dist=q_dist, conv=args.conv)
    ...
    vae, dataset_loader = load_model_and_dataset(args.checkpt, use_cuda=use_cuda)
    logpx, dependence, information, dimwise_kl, analytical_cond_kl, marginal_entropies, joint_entropy = \
        elbo_decomposition(vae, dataset_loader, use_cuda=use_cuda)
    torch.save({
        'logpx': logpx,
